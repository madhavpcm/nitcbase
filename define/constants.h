...
#define INPUT_FILES_PATH                                                                                               \
	"../Files/Input_Files/" // Path to Input_Files directory inside the Files
							// directory
#define OUTPUT_FILES_PATH                                                                                              \
	"../Files/Output_Files/" // Path to Output_Files directory inside the Files
							 // directory
#define BATCH_FILES_PATH                                                                                               \
	"../Files/Batch_Execution_Files/" // Path to Batch_Execution_Files directory
...
#define BUFFER_CAPACITY                                                                                                \
	32 // Total number of blocks available in the Buffer (Capacity of the Buffer
	   // in blocks)
#define MAX_OPEN                                                                                                       \
	12								// Maximum number of relations allowed to be open and cached in Cache
									// Layer.
#define BLOCK_ALLOCATION_MAP_SIZE 4 // Number of blocks given for Block Allocation Map in the disk

#define RELCAT_NO_ATTRS                                                                                                \
	6 // Number of attributes present in one entry / record of the Relation
	  // Catalog
#define ATTRCAT_NO_ATTRS                                                                                               \
	6 // Number of attributes present in one entry / record of the Attribute
	  // Catalog
...
#define NO_OF_ATTRS_RELCAT_ATTRCAT                                                                                     \
	6 // Common variable to indicate the number of attributes present in one entry
	  // of Relation Catalog / Attribute Catalog
...
enum OpenRelationEntryStatus { OCCUPIED = 1, FREE = 0 };
...
enum ReturnTypes {
	...
	E_INDEX_BLOCKS_RELEASED, // Due to insufficient disk space, index blocks have
							 // been released from the disk
};
...
// Name strings for Relation Catalog and Attribute Catalog (as it is stored in
