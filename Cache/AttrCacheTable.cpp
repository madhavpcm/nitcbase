...
@param relId:
*/
int AttrCacheTable::getAttrCatEntry( int relId, int attrOffset, std::unique_ptr<AttrCatEntry>& attrCatBuf ) {
...
*/
void AttrCacheTable::recordToAttrCatEntry( union Attribute record[ ATTRCAT_NO_ATTRS ], std::unique_ptr<AttrCatEntry>& attrCatEntry ) {
